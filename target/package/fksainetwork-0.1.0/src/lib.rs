...
*
* Note to programmer:
* - Inputs of the neurons and activations should not be deleted as it is deleted by Network::~Network().
* - The float array of Network::output() should be deleted after being used.
*/
mod activation;
mod neuron;
mod tests;
